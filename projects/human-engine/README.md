...
├── physiology.py  # 生理层（精力/睡眠债/疲劳/睡眠结算）
...
- ✅ 社会关系图：好感/信任/权力差/依恋激活随事件演化，社会支持作为 COR 资源
  （高支持 → seek_support 收益更高；权力差压制直接对抗→回避/寻求支持）
- ✅ 生理层：精力消耗 + 睡眠债累积，疲劳减慢自控/应激恢复；睡眠是最大恢复源
