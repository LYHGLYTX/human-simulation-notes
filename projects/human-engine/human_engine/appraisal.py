...
EVENT_TYPES: dict[str, dict] = {
    ...
    "criticism":    {"valence": -0.4, "novelty": 0.3, "relevance": 0.5, "kw": ["批评", "指责", "挑剔", "criticism", "criticize", "你不行", "废物", "没用", "失望", "不满意"]},
    "rejection":    {"valence": -0.5, "novelty": 0.4, "relevance": 0.6, "kw": ["拒绝", "不行", "驳回", "没通过", "reject", "refuse", "denied", "没选上", "滚", "冷静一段时间", "冷静一下", "保持距离"]},
    ...
    "abandonment":  {"valence": -0.9, "novelty": 0.5, "relevance": 0.95, "kw": ["分手", "离开我", "抛弃", "不要我", "抛下我", "丢下我", "abandon", "left me", "breakup", "离婚", "没人要", "没人记得", "累赘"]},
    "loss":         {"valence": -0.75, "novelty": 0.6, "relevance": 0.8, "kw": ["去世", "离世", "过世", "失去", "破产", "失业", "开除", "loss", "died", "death", "fired", "失去工作", "重病", "猝死", "裁员", "涨价", "见底", "亏光"]},
    "threat":       {"valence": -0.7, "novelty": 0.7, "relevance": 0.85, "kw": ["威胁", "恐吓", "打你", "打我", "打人", "殴打", "挨打", "揍", "暴力", "threat", "violence", "杀你", "杀了", "杀人", "杀死", "杀害", "杀我", "刀", "囚禁", "虐待", "跟踪", "绑架"]},
